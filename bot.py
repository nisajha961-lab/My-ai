...
# लॉबिंग सेटिंग्स (रेलवे लॉग्स के लिए)
...
# 🎯 तुम्हारी फिक्स टेलीग्राम आईडी (अब बोट सिर्फ तुम्हारे इशारों पर चलेगा)
...
def is_authorized(update: Update) -> bool:
    ...
    # सुरक्षा चक्र: सिर्फ तुम्हारी आईडी मैच होने पर ही काम करेगा
